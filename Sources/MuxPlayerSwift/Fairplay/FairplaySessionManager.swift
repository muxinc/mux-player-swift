...
//        print("POST BODY: \(postData)")
        ...
        let task = urlSession.dataTask(with: request) { [completion] data, response, error in
            ...
            if let httpResponse = response as? HTTPURLResponse {
                ...
                // TODO: Check for error codes here. Checking for a body isn't enough because erorr responses have
                //  bodies (the erorr bodies are base64-encoeded utf-8, generated by castlabs, proxied to us by mux)
